...
public class FrontQuestionService extends BaseService {
	...
	public boolean deleteMessageById(int id, int userId){
		return fmessageDAO.deleteById(id, userId);
	}

	public boolean updateMessageRead(int id, int userId){
		return fmessageDAO.readMessage(id, userId);
	}
