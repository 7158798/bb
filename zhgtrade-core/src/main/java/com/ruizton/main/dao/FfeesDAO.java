...
public class FfeesDAO extends HibernateDaoSupport {
	...
	public Ffees findById(java.lang.Integer id) {
		...
		try {
			Ffees instance = (Ffees) getSession().get("com.ruizton.main.model.Ffees", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Ffees> findByExample(Ffees instance) {
		...
		try {
			List<Ffees> results = (List<Ffees>) getSession().createCriteria("com.ruizton.main.model.Ffees").add(create(instance)).list();
