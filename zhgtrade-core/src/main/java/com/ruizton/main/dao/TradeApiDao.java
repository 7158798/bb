...
public class TradeApiDao extends HibernateDaoSupport {
    ...
    public TradeApi findById(int id){
        Query query = getSession().createQuery("from com.ruizton.main.model.TradeApi where id = " + id);
    ...
    public TradeApi findByKey(String key){
        Query queryObject = getSession().createQuery("from com.ruizton.main.model.TradeApi as model where model.apiKey =:key");
    ...
    public List<TradeApi> listByUser(int userId){
        Query queryObject = getSession().createQuery("from com.ruizton.main.model.TradeApi where userId =:userId order by id desc");
    ...
    public int countByUser(int userId){
        Query queryObject = getSession().createQuery("select count(model.id) from com.ruizton.main.model.TradeApi as model where model.userId =:userId");
        queryObject.setParameter("userId", userId);
        return ((Long)queryObject.uniqueResult()).intValue();
    }

    public int countByUserAndType(int userId, TradeApiType type){
        Query queryObject = getSession().createQuery("select count(model.id) from com.ruizton.main.model.TradeApi as model where model.userId =:userId and model.type =:type");
        queryObject.setParameter("userId", userId);
