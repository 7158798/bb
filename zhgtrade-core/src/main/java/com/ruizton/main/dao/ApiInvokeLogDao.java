...
public class ApiInvokeLogDao extends HibernateDaoSupport {
    ...
    public List<ApiInvokeLog> findByUser(int userId, int firstResult, int maxResult){
        Query query = getSession().createQuery("from com.ruizton.main.model.ApiInvokeLog where userId = " + userId + " order by id desc");
    ...
    public List<ApiInvokeLog> findByApi(int apiId, int firstResult, int maxResult){
        Query query = getSession().createQuery("from com.ruizton.main.model.ApiInvokeLog where apiId = " + apiId + " order by id desc");
