...
<div class="m14 text-center" style="background: url('${resources}/static/images/coin/bg5.jpg')">
    <h1>关于区块链项目退市的方案</h1>
    <p>
        请注意，为了用户的资金安全和正常投资，我们会慎重考虑区块链资产退市下架，但若在比特家平台已上线的区块链资产（或数字货币）出现下列情况之一，我们会通知项目开发团队改进，如仍拒不改进或不作为， 我们将会提前公告并下线该区块链资产（或币种）。因下线后导致比特家平台与其他平台用户的任何损失均由该项目开发团队承担。项目开发团队须与比特家平台签署协议即表示充分了解比特家平台下币规则，并自愿承担因此产生的所有风险。
    </p>
    <p>
    ...
    <p>
        （4）比特家平台认为该币种开发团队涉嫌恶意操盘砸盘等欺诈行为的，比特家平台有权采取查封涉嫌恶意操盘砸盘的用户注册号、冻结用于恶意操盘砸盘操作的资金帐户、暂停该币种交易、向国家有权管理的机关举报和投诉以及对该数字货币予以下线处理等措施；如比特家平台或者其平台用户因该币种官方团队存在本条约定之行为给用户造成损失的，比特家平台将从所冻结的资金帐户中的资金直接用于弥补各方损失，不足部分比特家平台及用户有权向该币种官方团队进行追索。
    </p>
    <p>
        （5）有超过80%的持有该数字货币用户（帐户数或者持币数量二者有一项满足80%以上的标准即可）强烈要求下线该币种或者其它由于该币种而影响比特家平台声誉的情况。
    </p>
</div>
