...
//		/*if(buyEntrust==null){
//			buyEntrust = new HashMap<Integer,List<Fentrust>>();
//		}
//		if(sellEntrust==null){
//			sellEntrust = new HashMap<Integer,List<Fentrust>>();
//		}*/
//		try{
//			List<Fvirtualcointype> list = frontVirtualCoinService.findFvirtualCoinType(VirtualCoinTypeStatusEnum.Normal);
//			for(Fvirtualcointype fvirtualcointype : list){
...
////				realTimeData.updateCancleBuyEntrust(vid, EntrustRobotStatusEnum.Robot2);
////				realTimeData.updateCancleSellEntrust(vid, EntrustRobotStatusEnum.Robot2);
//				/*if(buyEntrust.get(vid)!=null){
//					ArrayList<Fentrust> entrusts = (ArrayList<Fentrust>) buyEntrust.get(vid);
//					for(int i=0; i<entrusts.size(); i++){
//						Fentrust entrust = entrusts.get(i);
//						Fuser fuser = entrust.getFuser();
//						frontTradeService.updateCancelFentrust(entrust, fuser);
//						realTimeData.removeEntrustBuyMap(vid, entrust);
//					}
//					buyEntrust.remove(vid);
//				}
//
//				if(sellEntrust.get(vid)!=null){
//					ArrayList<Fentrust> entrusts = (ArrayList<Fentrust>) sellEntrust.get(vid);
//					for(int i=0; i<entrusts.size(); i++){
//						Fentrust entrust = entrusts.get(i);
//						Fuser fuser = entrust.getFuser();
//						frontTradeService.updateCancelFentrust(entrust, fuser);
//						realTimeData.removeEntrustSellMap(vid, entrust);
//					}
//					sellEntrust.remove(vid);
//				}*/
//
