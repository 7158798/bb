...
<div class="pageContent">
    <div class="panelBar">
        ...
        <ul class="toolBar">
            <%--<shiro:hasPermission name="ssadmin/updateVirtualCoinOrder.html">--%>
                <%--<li>--%>
                    <%--<a class="edit"--%>
                       <%--href="ssadmin/goVirtualCoinOrder.html?url=ssadmin/editVirtualCoinOrder&uid={sid_user}"--%>
                       <%--height="600" width="800" target="dialog"><span>修改Order</span> </a>--%>
                <%--</li>--%>
            <%--</shiro:hasPermission>--%>
            <li>
                <a class="edit"
            ...
            <li>
                <a class="edit"
                   href="/ssadmin/virtualCoinOrder.html?type=1" target="navTab"
                   height="600" width="800"><span>币主板排序</span> </a>
            </li>
            <li>
                <a class="edit"
                   href="/ssadmin/virtualCoinOrder.html?type=2" target="navTab"
                   height="600" width="800"><span>币三板排序</span> </a>
            </li>
            <li>
                <a class="edit"
                   href="/ssadmin/virtualCoinOrder.html?type=3" target="navTab"
                   height="600" width="800"><span>权益排序</span> </a>
            </li>
    ...
    <table class="table" width="40%" layoutH="138">
        ...
        <tr>
            ...
            <c:choose>
                ...
                <c:when test="${type == 1}">
                    <th width="50">币主板排序</th>
                </c:when>
                <c:when test="${type == 2}">
                    <th width="50">币三板排序</th>
                </c:when>
                <c:when test="${type == 3}">
                    <th width="50">权益排序</th>
                </c:when>
