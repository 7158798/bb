			...
			<dl>
				...
				<dd>
					<select class="required" type="combox" name="coinTradeType">
						...
						<option <c:if test="${1 == virtualCoinType.coinTradeType}">selected="selected"</c:if> value="1">币主板</option>
						<option <c:if test="${2 == virtualCoinType.coinTradeType}">selected="selected"</c:if> value="2">币三板</option>
					</select>
				</dd>
			</dl>
			<dl>
