...
<%-- 				<th width="60" orderField="fborrowBtc"
					<c:if test='${param.orderField == "fborrowBtc" }'> class="${param.orderDirection}"  </c:if>>已借款数量</th>
				<th width="60" orderField="fcanlendBtc"
					<c:if test='${param.orderField == "fcanlendBtc" }'> class="${param.orderDirection}"  </c:if>>可放款数量</th>
				<th width="60" orderField="falreadyLendBtc"
					<c:if test='${param.orderField == "falreadyLendBtc" }'> class="${param.orderDirection}"  </c:if>>冻结放款数量</th>
				<th width="60" orderField="falreadyLendBtc"
					<c:if test='${param.orderField == "falreadyLendBtc" }'> class="${param.orderDirection}"  </c:if>>已放款数量</th>
...
<%-- 					<td>${virtualwallet.fborrowBtc}</td>
					<td>${virtualwallet.fcanlendBtc}</td>
					<td>${virtualwallet.ffrozenLendBtc}</td>
					<td>${virtualwallet.falreadyLendBtc}</td> --%>
