...
public class BalanceController extends BaseController {
	...
	@RequiresPermissions("ssadmin/balanceList.html")
	...
	public ModelAndView goBalanceJSP(HttpServletRequest request) throws Exception{
	...
	@RequiresPermissions("ssadmin/updateBalance.html")
	public ModelAndView updateBalance(HttpServletRequest request) throws Exception{
		ModelAndView modelAndView = new ModelAndView() ;
        int fid = Integer.parseInt(request.getParameter("fid"));
        Fbalance balance = this.balanceService.findById(fid);
        balance.setFcreatetime(Utils.getTimestamp());
        balance.setFintrolRate(Double.valueOf(request.getParameter("fintrolRate")));
